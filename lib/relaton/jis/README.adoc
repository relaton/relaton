...
To update the index test fixture (used by tests), download the latest `index-v2.zip` from the `v2` branch of the https://github.com/relaton/relaton-data-jis[relaton-data-jis] repository into `spec/jis/fixtures/`.
