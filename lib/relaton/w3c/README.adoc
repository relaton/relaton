...
To update the index test fixture (used by tests), download the latest published index from the https://github.com/relaton/relaton-data-w3c[relaton-data-w3c] repository into `spec/w3c/fixtures/`. There is no `rake spec:update_index` task.
