...
The index test fixture is `spec/iana/fixtures/index-v2.zip` — the pubid-keyed `index-v2` published by the https://github.com/relaton/relaton-data-iana[relaton-data-iana] repository (branch `v2`). To refresh it, download the live `index-v2.zip` and replace the fixture.
