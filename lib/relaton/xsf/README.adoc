...
The XSF Library dataset provides documents listed in the https://github.com/relaton/relaton-data-xsf/blob/v2/index-v2.yaml[index].
...
To update the index test fixture (used by tests), run `rake spec:update_index_xsf`. This downloads the latest published index from the https://github.com/relaton/relaton-data-xsf[relaton-data-xsf] repository.
