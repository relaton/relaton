...
The index test fixture used by the tests is `spec/oasis/fixtures/index-v2.zip`, a verbatim copy of the published `index-v2.zip` from the https://github.com/relaton/relaton-data-oasis[relaton-data-oasis] repository. Refresh it with `rake spec:update_index_oasis`.
