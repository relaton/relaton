...
describe Relaton::ThreeGpp::Processor do
  ...
  # The cold path Db#clear reaches without Bibliography ever loading. It
  # needs `url: true` to name the cached file, and no `pubid_class:`:
  # Type#remove_file deletes the file and never reads the index.
  it "#remove_index_file" do
    ...
    expect(Relaton::Index).to receive(:find_or_create)
      .with("3GPP", url: true, file: "index-v2.yaml").and_return index
