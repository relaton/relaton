describe Relaton::Bib::Converter::Bibtex::ToBibtex do
  ...
  it "render article" do
    item = Relaton::Bib::Item.from_xml File.read("fixtures/bibtex_article.xml", encoding: "UTF-8")
  ...
  it "render book, rpoceedings" do
    bibitem = Relaton::Bib::Item.from_xml File.read("fixtures/bibtex_book.xml", encoding: "UTF-8")
  ...
  it "render inbook, incollection" do
    bibitem = Relaton::Bib::Item.from_xml File.read("fixtures/bibtex_inbook.xml", encoding: "UTF-8")
    expect(bibitem.to_bibtex).to eq <<~"OUTPUT"
      @inbook{DOC123,
        title = {Title},
        author = {Doe, John and Brown, Mike},
  ...
  it "render inproceedings" do
    bibitem = Relaton::Bib::Item.from_xml File.read("fixtures/bibtex_inproceedings.xml", encoding: "UTF-8")
    expect(bibitem.to_bibtex).to eq <<~"OUTPUT"
  ...
  it "render phdthesis" do
    bibitem = Relaton::Bib::Item.from_xml File.read("fixtures/bibtex_phdthesis.xml", encoding: "UTF-8")
    expect(bibitem.to_bibtex).to eq <<~"OUTPUT"
      @phdthesis{DOC123,
        title = {Title},
        author = {Doe, John and Brown, Mike},
  ...
  it "render techreport" do
    bibitem = Relaton::Bib::Item.from_xml File.read("fixtures/bibtex_techreport.xml", encoding: "UTF-8")
    expect(bibitem.to_bibtex).to eq <<~"OUTPUT"
      @techreport{DOC123,
        title = {Title},
        author = {Doe, John and Brown, Mike},
  ...
  it "render standard" do
    bibitem = Relaton::Bib::Item.from_yaml File.read("fixtures/item.yaml", encoding: "UTF-8")
    expect(bibitem.to_bibtex).to eq <<~"OUTPUT"
      @misc{ISO1231994,
