...
model.
  ...
  spec.add_dependency "relaton-calconnect", "~> 0.6.0"
  spec.add_dependency "relaton-gb", "~> 0.11.0"
  spec.add_dependency "relaton-iec", "~> 0.9.0"
  spec.add_dependency "relaton-ietf", "~> 0.11.0"
  spec.add_dependency "relaton-iso", "~> 0.11.0"
  spec.add_dependency "relaton-itu", "~> 0.8.0"
