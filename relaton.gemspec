...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency "relaton-calconnect", "~> 0.7.0"
  spec.add_dependency "relaton-gb", "~> 0.12.0"
  spec.add_dependency "relaton-iec", "~> 0.10.0"
  spec.add_dependency "relaton-ietf", "~> 0.12.0"
  spec.add_dependency "relaton-iso", "~> 0.12.0"
  spec.add_dependency "relaton-itu", "~> 0.9.0"
  spec.add_dependency "relaton-nist", "~> 0.9.0"
