...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency "relaton-3gpp", "~> 1.10.0"
  spec.add_dependency "relaton-bipm", "~> 1.10.0"
  spec.add_dependency "relaton-bsi", "~> 1.10.0"
  spec.add_dependency "relaton-calconnect", "~> 1.10.0"
  spec.add_dependency "relaton-cen", "~> 1.10.0"
  spec.add_dependency "relaton-cie", "~> 1.10.0"
  spec.add_dependency "relaton-ecma", "~> 1.10.0"
  spec.add_dependency "relaton-gb", "~> 1.10.0"
  spec.add_dependency "relaton-iana", "~> 1.10.0"
  spec.add_dependency "relaton-iec", "~> 1.10.0"
  spec.add_dependency "relaton-ieee", "~> 1.10.0"
  spec.add_dependency "relaton-ietf", "~> 1.10.0"
  spec.add_dependency "relaton-iho", "~> 1.10.0"
  spec.add_dependency "relaton-iso", "~> 1.10.0"
  spec.add_dependency "relaton-itu", "~> 1.10.0"
  spec.add_dependency "relaton-nist", ">= 1.10.0"
  spec.add_dependency "relaton-ogc", "~> 1.10.0"
  spec.add_dependency "relaton-omg", "~> 1.10.0"
  spec.add_dependency "relaton-un", "~> 1.10.0"
