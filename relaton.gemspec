...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency "relaton-calconnect", "~> 1.1.0"
  spec.add_dependency "relaton-gb", "~> 1.1.0"
  spec.add_dependency "relaton-iec", "~> 1.1.0"
  spec.add_dependency "relaton-ieee", "~> 1.1.0"
  spec.add_dependency "relaton-ietf", "~> 1.1.0"
  spec.add_dependency "relaton-iso", "~> 1.1.0"
  spec.add_dependency "relaton-itu", "~> 1.1.0"
  spec.add_dependency "relaton-nist", "~> 1.1.0"
  spec.add_dependency "relaton-ogc", "~> 1.1.0"
  spec.add_dependency "relaton-omg", "~> 1.1.0"
  spec.add_dependency "relaton-un", "~> 1.1.0"
  spec.add_dependency "relaton-w3c", "~> 1.1.0"
