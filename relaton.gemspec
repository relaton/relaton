...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency "relaton-calconnect", ">= 1.0.1"
  spec.add_dependency "relaton-gb", "~> 1.0.1"
  spec.add_dependency "relaton-iec", ">= 1.0.1"
  spec.add_dependency "relaton-ietf", ">= 1.0.2"
  spec.add_dependency "relaton-iso", ">= 1.0.3"
  spec.add_dependency "relaton-itu", ">= 1.0.4"
  spec.add_dependency "relaton-nist", ">= 1.0.1"
  spec.add_dependency "relaton-ogc", ">= 1.0.1"
  spec.add_dependency "relaton-omg", ">= 1.0.1"
  spec.add_dependency "relaton-un", ">= 1.0.1"
  spec.add_dependency "relaton-w3c", ">= 1.0.1"
