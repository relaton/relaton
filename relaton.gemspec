...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency "relaton-3gpp", "~> 1.10.1"
  spec.add_dependency "relaton-bipm", "~> 1.10.1"
  spec.add_dependency "relaton-bsi", "~> 1.10.1"
  spec.add_dependency "relaton-calconnect", "~> 1.10.1"
  spec.add_dependency "relaton-cen", "~> 1.10.1"
  spec.add_dependency "relaton-cie", "~> 1.10.1"
  spec.add_dependency "relaton-ecma", "~> 1.10.1"
  spec.add_dependency "relaton-gb", "~> 1.10.1"
  spec.add_dependency "relaton-iana", "~> 1.10.1"
  spec.add_dependency "relaton-iec", "~> 1.10.1"
  spec.add_dependency "relaton-ieee", "~> 1.10.1"
  spec.add_dependency "relaton-ietf", "~> 1.10.1"
  spec.add_dependency "relaton-iho", "~> 1.10.1"
  ...
  spec.add_dependency "relaton-w3c", "~> 1.10.1"
