...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency "relaton-3gpp", "~> 2.0.0.alpha.1"
  spec.add_dependency "relaton-bipm", "~> 2.0.0.alpha.1"
  spec.add_dependency "relaton-bsi", "~> 2.0.0.alpha.1"
  spec.add_dependency "relaton-calconnect", "~> 2.0.0.alpha.1"
  spec.add_dependency "relaton-ccsds", "~> 2.0.0.alpha.1"
  spec.add_dependency "relaton-cen", "~> 2.0.0.alpha.1"
  spec.add_dependency "relaton-cie", "~> 2.0.0.alpha.1"
  spec.add_dependency "relaton-doi", "~> 2.0.0.alpha.1"
  spec.add_dependency "relaton-ecma", "~> 2.0.0.alpha.1"
  spec.add_dependency "relaton-etsi", "~> 2.0.0.alpha.1"
  spec.add_dependency "relaton-gb", "~> 2.0.0.alpha.1"
  spec.add_dependency "relaton-iana", "~> 2.0.0.alpha.1"
  spec.add_dependency "relaton-iec", "~> 2.0.0.alpha.1"
  spec.add_dependency "relaton-ieee", "~> 2.0.0.alpha.1"
  spec.add_dependency "relaton-ietf", "~> 2.0.0.alpha.1"
  spec.add_dependency "relaton-iho", "~> 2.0.0.alpha.1"
  spec.add_dependency "relaton-isbn", "~> 2.0.0.alpha.1"
  spec.add_dependency "relaton-iso", "~> 2.0.0.alpha.1"
  spec.add_dependency "relaton-itu", "~> 2.0.0.alpha.1"
  spec.add_dependency "relaton-jis", "~> 2.0.0.alpha.1"
  spec.add_dependency "relaton-nist", "~> 2.0.0.alpha.1"
  spec.add_dependency "relaton-oasis", "~> 2.0.0.alpha.1"
  spec.add_dependency "relaton-ogc", "~> 2.0.0.alpha.1"
  ...
  spec.add_dependency "relaton-w3c", "~> 2.0.0.alpha.1"
